...
- 原理图
    ...
    ![I2C原理图](/assets/images/i2c_schematic.png "I2C原理图")
...
- 随机读操作，单字节地址
    ...
    ![I2C随机读](/assets/images/i2c_read_random_1.png "I2C随机读，单字节地址")

- 随机读操作，2字节地址
  
    ![I2C随机读](/assets/images/i2c_read_random_2.png "I2C随机读，2字节地址")
